package com.yurirvs.saiph.framework.mq.producer;

import com.yurirvs.saiph.framework.mq.MessageWrapper;
...
public class DelegatingTransactionListener implements RocketMQLocalTransactionListener {
    ...
    public RocketMQLocalTransactionState executeLocalTransaction(Message msg, Object arg) {
        String txId = (String) msg.getHeaders().get(HEADER_TX_ID);
    ...
    public RocketMQLocalTransactionState checkLocalTransaction(Message msg) {
        String topic = (String) msg.getHeaders().get(HEADER_TOPIC);
        ...
        try {
            MessageWrapper<?> wrapper = (MessageWrapper<?>) msg.getPayload();
