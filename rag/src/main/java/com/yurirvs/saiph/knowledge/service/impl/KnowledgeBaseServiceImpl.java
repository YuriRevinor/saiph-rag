...
import com.yurirvs.saiph.knowledge.mq.event.KnowledgeBaseCleanupEvent;
...
public class KnowledgeBaseServiceImpl implements KnowledgeBaseService {
    ...
    public String create(KnowledgeBaseCreateDTO requestParam) {
        // 名称重复校验
    ...
    public void update(KnowledgeBaseUpdateDTO requestParam) {
    ...
    public void rename(String kbId, KnowledgeBaseUpdateDTO requestParam) {
    ...
    @Override
    public IPage<KnowledgeBaseVO> pageQuery(KnowledgeBasePageDTO requestParam) {
