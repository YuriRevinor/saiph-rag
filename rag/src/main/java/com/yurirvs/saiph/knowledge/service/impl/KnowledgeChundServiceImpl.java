...
import com.yurirvs.saiph.core.chunk.model.Chunk;
import com.yurirvs.saiph.core.chunk.model.ChunkAssembler;
import com.yurirvs.saiph.core.chunk.model.EmbeddedChunk;
import com.yurirvs.saiph.core.ingest.VectorTarget;
import com.yurirvs.saiph.core.ingest.embed.ChunkEmbeddingService;
...
import com.yurirvs.saiph.knowledge.controller.dto.KnowledgeChunkBatchDTO;
import com.yurirvs.saiph.knowledge.controller.dto.KnowledgeChunkCreateDTO;
import com.yurirvs.saiph.knowledge.controller.dto.KnowledgeChunkPageDTO;
import com.yurirvs.saiph.knowledge.controller.dto.KnowledgeChunkUpdateDTO;
import com.yurirvs.saiph.knowledge.controller.vo.KnowledgeChunkVO;
...
public class KnowledgeChundServiceImpl implements KnowledgeChunkService {
    ...
    @Override
    public IPage<KnowledgeChunkVO> pageQuery(String docId, KnowledgeChunkPageDTO requestParam) {
        ...
        Page<KnowledgeChunkDO> page = new Page<KnowledgeChunkDO>(requestParam.getCurrent(),requestParam.getSize());
    ...
    public KnowledgeChunkVO create(String docId, KnowledgeChunkCreateDTO requestParam) {
        KnowledgeDocumentDO documentDO = documentMapper.selectById(docId);
        Assert.notNull(documentDO, () -> new ClientException("文档不存在"));
    ...
    public void update(String docId, String chunkId, KnowledgeChunkUpdateDTO requestParam) {
        KnowledgeDocumentDO documentDO = documentMapper.selectById(docId);
        Assert.notNull(documentDO, () -> new ClientException("文档不存在"));
        if (DocumentStatus.RUNNING.getCode().equals(documentDO.getStatus())) {
    ...
    public void batchToggleEnabled(String docId, KnowledgeChunkBatchDTO requestParam, boolean enabled) {
