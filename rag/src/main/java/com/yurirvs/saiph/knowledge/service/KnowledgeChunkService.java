...
public interface KnowledgeChunkService {
     ...
     * @return 分片分页信息
     */
    IPage<KnowledgeChunkVO> pageQuery(String docId, KnowledgeChunkPageDTO requestParam);
     ...
     * @return 新增的分片视图对象
     */
    KnowledgeChunkVO create(String docId, KnowledgeChunkCreateDTO requestParam);
     ...
     */
    void update(String docId, String chunkId, KnowledgeChunkUpdateDTO requestParam);
     ...
     */
    void batchToggleEnabled(String docId, KnowledgeChunkBatchDTO requestParam, boolean enabled);
