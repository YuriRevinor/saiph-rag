...
public class StreamTaskManager {
    ...
    private static final String CANCEL_TOPIC = "saiph:stream:cancel";
    private static final String CANCEL_KEY_PREFIX = "saiph:stream:cancel:";
    ...
    private void sendCancelAndDone(SseEmitterSender sender, CompletionPayload payload) {
        ...
        sender.send(SSEEventType.CANCEL.value(), actualPayload);
