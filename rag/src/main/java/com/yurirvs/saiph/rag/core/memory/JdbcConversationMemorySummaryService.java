...
import com.yurirvs.saiph.infra.enums.Tier;
import com.yurirvs.saiph.rag.config.MemoryProperties;
...
import com.yurirvs.saiph.rag.core.source.CitationMarkup;
...
public class JdbcConversationMemorySummaryService implements ConversationMemorySummaryService {
    ...
    private static final String SUMMARY_LOCK_PREFIX = "saiph:memory:summary:lock:";
