...
import com.yurirvs.saiph.rag.config.RagStorageProperties;
import com.yurirvs.saiph.rag.core.storage.ObjectStorageClient;
...
public class DefaultFileStorageService implements FileStorageService {
    ...
    private static final String LOCK_KEY_PREFIX = "saiph:kb:space:init:";
