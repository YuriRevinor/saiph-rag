package com.yurirvs.saiph.ingestion.node;

import com.yurirvs.saiph.core.parser.mime.MimeTypeDetector;
import com.yurirvs.saiph.framework.exception.ClientException;
import com.yurirvs.saiph.ingestion.domain.context.DocumentSource;
import com.yurirvs.saiph.ingestion.domain.context.IngestionContext;
import com.yurirvs.saiph.ingestion.domain.enums.IngestionNodeType;
import com.yurirvs.saiph.ingestion.domain.enums.SourceType;
import com.yurirvs.saiph.ingestion.domain.pipeline.NodeConfig;
import com.yurirvs.saiph.ingestion.domain.result.NodeResult;
import com.yurirvs.saiph.ingestion.strategy.fetcher.DocumentFetcher;
import com.yurirvs.saiph.ingestion.strategy.fetcher.FetchResult;
